                  ...
                  <td className="size-px whitespace-nowrap align-top">
                    <a className="block p-6" href="#">
                      <div className="flex items-center gap-x-4">
                        <img
                          className="shrink-0 size-[100px] rounded-lg"
                          src="https://img.freepik.com/free-photo/chicken-skewers-with-slices-sweet-peppers-dill_2829-18813.jpg?t=st=1723358098~exp=1723361698~hmac=06b2d960e0b2c9fb9eb4bb45e9071468cfe62fa1f9b45c3a2cd9e456a89a2fd8&w=2000"
                          alt="Product Image"
                        />
                        <div>
                          <span className="block text-sm font-semibold text-gray-800 dark:text-neutral-200">
...
Chicken tikka is marinated, grilled chicken with spices and yogurt, offering a tender, smoky flavor, often served with naan
                      </span>
                    </a>
                  </td>
                  <td className="size-px whitespace-nowrap align-top">
                ...
                <tr className="bg-white hover:bg-gray-50 dark:bg-neutral-900 dark:hover:bg-neutral-800">
                  <td className="size-px whitespace-nowrap align-top">
                    <a className="block p-6" href="#">
                      <div className="flex items-center gap-x-4">
                        <img
                          className="shrink-0 size-[100px] rounded-lg"
                          src="https://img.freepik.com/free-photo/gourmet-italian-bolognese-pasta-with-fresh-parmesan-generated-by-ai_188544-9453.jpg?t=st=1723358173~exp=1723361773~hmac=f20cba036b8c6939520fc9eb86b2f41644213250ba8a681c3d28da6364265f6a&w=2000"
                          alt="Product Image"
                        />
                        <div>
                          <span className="block text-sm font-semibold text-gray-800 dark:text-neutral-200">
                  ...
                  <td className="h-px w-72 min-w-72 align-top">
                    <a className="block p-6" href="#">
                      ...
                      <span className="block text-sm text-gray-500 dark:text-neutral-500">
Noodles are versatile, chewy strands of pasta, cooked in various sauces or stir-fries, often with vegetables and proteins
                      </span>
                    </a>
                  </td>
                  <td className="size-px whitespace-nowrap align-top">
                ...
                <tr className="bg-white hover:bg-gray-50 dark:bg-neutral-900 dark:hover:bg-neutral-800">
                  <td className="size-px whitespace-nowrap align-top">
                    <a className="block p-6" href="#">
                      <div className="flex items-center gap-x-4">
                        <img
                          className="shrink-0 size-[100px] rounded-lg"
                          src="https://img.freepik.com/premium-photo/pasta-fusilli-with-tomatoes-chicken-meat-parsley-plate-dark-table_2829-3397.jpg?w=2000"
                          alt="Product Image"
                        />
                        <div>
                          <span className="block text-sm font-semibold text-gray-800 dark:text-neutral-200">
                  ...
                  <td className="h-px w-72 min-w-72 align-top">
                    <a className="block p-6" href="#">
                      ...
                      <span className="block text-sm text-gray-500 dark:text-neutral-500">
Pasta is a versatile Italian dish made from wheat flour and water, served with various sauces, vegetables, and proteins.
                      </span>
                    </a>
                  </td>
                  <td className="size-px whitespace-nowrap align-top">
                ...
                <tr className="bg-white hover:bg-gray-50 dark:bg-neutral-900 dark:hover:bg-neutral-800">
                  <td className="size-px whitespace-nowrap align-top">
                    <a className="block p-6" href="#">
                      <div className="flex items-center gap-x-4">
                        <img
                          className="shrink-0 size-[100px] rounded-lg"
                          src="https://img.freepik.com/free-photo/delicious-fried-chicken-plate_144627-27383.jpg?t=st=1723358271~exp=1723361871~hmac=b06e27a85e70e0219da885b6e57b88898fb161abd2fc6b2f495ff78228e2985b&w=2000"
                          alt="Product Image"
                        />
                        <div>
                          <span className="block text-sm font-semibold text-gray-800 dark:text-neutral-200">
                  ...
                  <td className="h-px w-72 min-w-72 align-top">
                    <a className="block p-6" href="#">
                      ...
                      <span className="block text-sm text-gray-500 dark:text-neutral-500">
Chicken tandoori is marinated in yogurt and spices, then grilled, resulting in smoky, flavorful, and tender chicken with vibrant color
                      </span>
                    </a>
                  </td>
                  <td className="size-px whitespace-nowrap align-top">
