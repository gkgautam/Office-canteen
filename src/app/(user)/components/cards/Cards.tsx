  ...
  return (
   <>
          ...
          <div className=" flex flex-col justify-center items-center bg-blue-600 rounded-t-xl">
            {
                data.menuItemImage!==null &&
                <Image className='w-full h-60 object-cover' src={data.menuItemImage} width={500} height={500} alt='MenuItem Image'/>
            }
          </div>
