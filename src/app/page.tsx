...
import app_str from '/public/app_structure.webp';
    ...
    <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
      <div>
        <h1 className="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">
          ...
          OfficeBite Management Solution
        </h1>
        ...
        <div className="max-w-2xl text-center mx-auto">
          ...
          <div className="mt-5 max-w-2xl">
            <h1 className="block font-semibold text-gray-800 text-4xl md:text-5xl lg:text-6xl dark:text-neutral-200">
                What OfficeBite Offers
            </h1>
          </div>
          {/* End Title */}
          <div className="mt-5 max-w-3xl">
            <p className="text-lg text-gray-600 dark:text-neutral-400">
            OfficeBite offers an automated cafeteria management system that streamlines menu management, order placement, and payment, reducing queues and food waste. Available both on-premise and on-cloud, it enhances service quality, transparency, and efficiency. The software replaces manual processes, ensuring accuracy and saving time.
            </p>
          </div>
          {/* Buttons */}
...
<div className="relative">
  <Image
          src={app_str} // Path to the image in the public folder
          alt="Working"
          // layout="fill"
          // objectFit="cover" 
          // priority 
    ...
    <div className="grid sm:grid-cols-2 sm:items-center gap-8">
      ...
      <div className="sm:order-1">
        ...
        <div className="space-y-3">
          ...
          Managing the daily menu can be a laborious and time-consuming process. However, with Office Cafeteria Management, this task becomes efficient and streamlined. The software enables administrators to create an extensive range of 255 food items and pre-schedule 48 different menus for specific days and defined times. This feature empowers users to easily select any item from the menu as per their requirements.
          </p>
        </div>
        <p className="text-lg text-gray-800 dark:text-neutral-200">
        Office Cafeteria Management provides a professional solution for planning food menus intelligently. By utilizing this software, administrators can save significant time and effort in deciding daily menus. The ability to pre-schedule menus ensures smooth operations and eliminates the need for daily menu planning. With a wide variety of food options available, users can conveniently choose their desired items from the menu. This professional and user-friendly approach simplifies cafeteria management, enhancing efficiency and overall satisfaction.
        </p>
      ...
      >
        <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-5">
          ...
          <div className="grow">
            ...
            Supports multiple credentials such as face recognition, fingerprint, and mobile authentication
            </p>
      ...
      >
        <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-5">
          ...
          <div className="grow">
            ...
            <p className="mt-3 text-gray-600 dark:text-neutral-400">
            Automatic blocking of users with transactions that exceed fixed daily or monthly limits, ensuring robust checks to prevent unauthorized usage
            </p>
            <p className="mt-4 inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 group-hover:underline group-focus:underline font-medium dark:text-blue-500">
              Read more
              <svg
      ...
      >
        <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-5">
          ...
          <div className="grow">
            ...
            <p className="mt-3 text-gray-600 dark:text-neutral-400">
            Offers payroll integration, enabling seamless data transfer to third-party systems, reducing administrative work and ensuring adaptability
            </p>
            <p className="mt-4 inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 group-hover:underline group-focus:underline font-medium dark:text-blue-500">
              Read more
              <svg
      ...
      >
        <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-5">
          ...
          <div className="grow">
            ...
            <p className="mt-3 text-gray-600 dark:text-neutral-400">
            Offers customization in menu with 255 options, accommodating diverse food items and multiple vendors, providing flexibility to meet endless menu requirements
            </p>
            <p className="mt-4 inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 group-hover:underline group-focus:underline font-medium dark:text-blue-500">
              Read more
              <svg
      ...
      >
        <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-5">
          ...
          <div className="grow">
            ...
            <p className="mt-3 text-gray-600 dark:text-neutral-400">
            Allows self-activation of scheduled recharges and payments without any manual intervention, ensuring a smooth cashless experience
            </p>
            <p className="mt-4 inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 group-hover:underline group-focus:underline font-medium dark:text-blue-500">
              Read more
              <svg
      ...
      >
        <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-5">
          ...
          <div className="grow">
            ...
            <p className="mt-3 text-gray-600 dark:text-neutral-400">
            Seamlessly integrate supported printers, enabling direct connection for printing receipts that display transaction details for easy record-keeping
            </p>
            <p className="mt-4 inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 group-hover:underline group-focus:underline font-medium dark:text-blue-500">
              Read more
              <svg
